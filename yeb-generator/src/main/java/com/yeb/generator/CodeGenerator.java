...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOpen(false);
        //xml开启 BaseResultMap
        gc.setBaseResultMap(true);//xml 开启BaseColumnList
        ...
        mpg.setCfg(cfg);
        // 配置模板
        TemplateConfig templateConfig = new TemplateConfig();//执行执行main方法，在控制台直接输出表名，多个表名用 , 隔开结果
